<?php
    ...
    $query = extraer_tipo_mantenimiento(base64_decode($_GET['id']));
...
<div class="panel panel-default" style="margin-top: 10 px">
    <div class="panel-heading">
        <h1>Actualizar Mantenimientos</h1>
    </div>
    ...
    <div class="panel-body">
        ...
        <form action="php/tipo_manten.php?accion=UDT" method ="POST">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-lg-offset-2 col-xs-12 col-xs-offset-0">
                ...
                <input type="text" name="codigo" id="codigo" require="" readonly="" class="form-control"  " value="<?php echo $row['codtipo_mant'] ?>">
                </div>
            </div>
